                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-gray-400 text-base leading-relaxed text-justify">
                            I hold a BA in Sociology from Sree Narayana Guru Open University and am currently advancing my skills through a comprehensive Digital Marketing program at <a 
                                href="https://oxdu.in/en/branch/oxdu-kondotty/" 
                                target="_blank" 
                                rel="noopener noreferrer" 
                                className="text-white font-medium hover:text-neon-blue transition-colors underline"
                            >
                                Oxdu Media School in Kondotty
                            </a>. This commitment to continuous learning ensures I stay ahead of the latest industry trends and tools, enabling me to consistently deliver high-impact, data-driven results for my clients. Feel free to <Link href="/#contact" className="text-neon-blue hover:text-neon-blue-dark hover:underline transition-colors font-medium">Contact Me</Link> to discuss how we can work together.
                        </p>
